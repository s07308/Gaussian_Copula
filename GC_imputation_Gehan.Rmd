...
```{r}
hist(unlist(sim2["bias", ]), main = "tau: -0.5, Censoring rate: 0.9", xlab = NA)

par(mfrow = c(1, 3))
hist((unlist(sim2["tau.hat", ]) / sd(unlist(sim2["tau.hat", ]))) ^ 2, main = "proposed")
hist(unlist(sim2["logrank", ]), main = "logrank")
hist(unlist(sim2["gehan", ]), main = "Gehan")
...
```{r}
hist(unlist(sim3["bias", ]), main = "tau: -0.5, Censoring rate: 0.9", xlab = NA)

par(mfrow = c(1, 3))
hist((unlist(sim3["tau.hat", ]) / sd(unlist(sim3["tau.hat", ]))) ^ 2, main = "proposed")
hist(unlist(sim3["logrank", ]), main = "logrank")
hist(unlist(sim3["gehan", ]), main = "Gehan")
...
```{r}
hist(unlist(sim4["bias", ]), main = "tau: -0.5, Censoring rate: 0.9", xlab = NA)

par(mfrow = c(1, 3))
hist((unlist(sim4["tau.hat", ]) / sd(unlist(sim4["tau.hat", ]))) ^ 2, main = "proposed")
hist(unlist(sim4["logrank", ]), main = "logrank")
hist(unlist(sim4["gehan", ]), main = "Gehan")
...
```{r}
hist(unlist(sim5["bias", ]), main = "tau: -0.5, Censoring rate: 0.9", xlab = NA)

par(mfrow = c(1, 3))
hist((unlist(sim5["tau.hat", ]) / sd(unlist(sim5["tau.hat", ]))) ^ 2, main = "proposed")
hist(unlist(sim5["logrank", ]), main = "logrank")
hist(unlist(sim5["gehan", ]), main = "Gehan")
